...
public class RandomUtils {
	...
	public static double randInnacuracy(double maxRadians) {
		return randDouble(maxRadians * 2) - maxRadians;
	}
	
	public static double randInnacuracyDegrees(double maxDegrees) {
		return randInnacuracy(Math.toRadians(maxDegrees));
	}
